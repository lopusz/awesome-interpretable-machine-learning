...
*** Philosophy
    ...
    + Interpretable machine learning: definitions, methods, and applications by William J. Murdoch, Chandan Singh, Karl Kumbier, Reza Abbasi-Asl, Bin Yu
...
*** Model Agnostic Explanations
    ...
    + Quantifying Interpretability of Arbitrary Machine Learning Models Through Functional Decomposition by Christoph Molnar, Giuseppe Casalicchio, Bernd Bischl
...
*** Model Specific Explanations - Neural Networks
    ...
    + Hierarchical interpretations for neural network predictions by Chandan Singh, William J. Murdoch, Bin Yu
...
** Extracting Interpretable Models From Complex Ones
   ...
   + Detecting Bias in Black-Box Models Using Transparent Model Distillation by Sarah Tan, Rich Caruana, Giles Hooker, Yin Lou
