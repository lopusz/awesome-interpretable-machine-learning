...
*** Philosophy
    ...
    + Interpretable machine learning: definitions, methods, and applications by W. James Murdoch, Chandan Singh, Karl Kumbier, Reza Abbasi-Asl, Bin Yu
...
*** Model Specific Explanations - Neural Networks
    ...
    + Hierarchical interpretations for neural network predictions by Chandan Singh, W. James Murdoch, Bin Yu
