...
** Good Old Feature Selection
   ...
   + Embedded methods
   + Varia
     + Model Class Reliance: Variable Importance Measures for any Machine Learning Model Class, from the "Rashomon" Perspective Class, from the "Rashomon" Perspective
     ...
     + Feature Engineering and Selection by Kuhn & Johnson
       + Sligtly off-topic, but very interesting books
